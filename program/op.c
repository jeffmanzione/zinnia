...
static const char *_op_strs[] = {
    ...
    "add",  "sub",  "mult", "div",  "mod",  "inc",  "dec",  "finc", "fdec",
    "sinc", "call", "clln", "tupl", "tgte", "tlte", "teq",  "dup",  "goto",
    "prnt", "lmdl", "get",  "gtsh", "rnil", "pnil", "fld",  "fldc", "is",
    "adr",  "rais", "ctch", "anew", "aidx", "aset", "cnst", "setc", "letc",
    "sget", "wait"};
