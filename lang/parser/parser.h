...
DefineSyntax(binary_and_expression);
DefineSyntax(binary_xor_expression);
DefineSyntax(binary_or_expression);
DefineSyntax(binary_and_expression1);
DefineSyntax(binary_xor_expression1);
DefineSyntax(binary_or_expression1);
